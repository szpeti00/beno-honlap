...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $secretKey = "y6LeQpP0pAAAAAKsUjc_5FNVEkS3uDbL2qTe6SoEd";
    ...
    if (empty($name) || empty($message) || !filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        echo "Oops! Valami hiba törént. Kérjük töltse ki az űrlapot és próbálja újra.";
        exit;
    }
    ...
    if (mail($recipient, $subject, $email_content, $email_headers)) {
        ...
        echo "Oops! Valami hiba törént. Kérjük próbálja újra.";
    }
} else {
